#!/usr/bin/env bash
# LP-GRPO: lambda=5.0 + zpd_strength=1.0 on qwen2.5-vl-7b + qwen2_5_vl 30k dataset.
# Based on 30k_tuned/run_lp_grpo_zpd1_30k_multinode.sh.
# Changes:
...
EXPERIMENT_NAME=${EXPERIMENT_NAME:-lp_grpo_zpd1_qwen2_5vl_30k_2node_$(date +%Y%m%d_%H%M)}
